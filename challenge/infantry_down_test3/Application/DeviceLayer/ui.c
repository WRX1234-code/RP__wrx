...
//	
//	if(vision_last_flag != (My_Balance.command->vision->Auto_Catch_Flag || My_Balance.command->vision->Auto_Dafu_Flag))
//	{
//		if((My_Balance.command->vision->Auto_Catch_Flag || My_Balance.command->vision->Auto_Dafu_Flag) == 1)
//		{
...
//	}
//	vision_last_flag = (My_Balance.command->vision->Auto_Catch_Flag || My_Balance.command->vision->Auto_Dafu_Flag);
...
//	
//	pitch_err_now = Chassis.Leg_Unit[];
...
//	
//	theta_err_now = -My_State_Var.theta_r;//右视图
