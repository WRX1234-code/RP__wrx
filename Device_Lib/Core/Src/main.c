...
/* USER CODE BEGIN PV */
RCDecoding_Type RC_ReceiveData;
uint32_t myTxMailbox;
uint8_t RC_Rx_Mem;
uint8_t RC_Receive[2][RC_FRAME_LEN+RC_FRAME_LEN_BACK];
/* USER CODE END PV */
...
void RC_Init()
{
    ...
    RC_ReceiveData.Switch_Left = RC_SW_MID;                      //switch left offset
    RC_ReceiveData.Switch_Right = RC_SW_MID;                     //switch right offset
