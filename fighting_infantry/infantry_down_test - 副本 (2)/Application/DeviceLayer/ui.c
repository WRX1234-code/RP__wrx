...
void Ui_Info_Update(void)
{
	...
	//陀螺框更新
	static bool top_last_mode = false;
	...
	//上台阶框更新
	static bool upstep_last_mode = false;
...
//	upstep_last_num = upstep_num;
	...
	static bool fly_last_mode = false;
	...
	if(vision_last_flag != D_Board_Rx_Info.vision_state)
	{
	...
	vision_last_flag = D_Board_Rx_Info.vision_state;
