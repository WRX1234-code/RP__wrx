...
void Judge_Update(uint16_t id, uint8_t *rxBuf)
{
    ...
    case ID_game_status:
        memcpy(&judge.info->game_status, rxBuf, LEN_game_status);
	      ...
	      {
		      D_Board_Tx_Pkt.is_video_open = 0;
	      }
	      else{
		      D_Board_Tx_Pkt.is_video_open = 1;
	      }
    ...
    case ID_game_robot_HP:
        memcpy(&judge.info->game_robot_HP, rxBuf, LEN_game_robot_HP);
		    ...
		    if(judge.info->game_status.game_progress != 4)
	      {
		      D_Board_Tx_Pkt.blood_0 = 10;
		      D_Board_Tx_Pkt.blood_1 = 10;
		      D_Board_Tx_Pkt.blood_2 = 10;
		      D_Board_Tx_Pkt.blood_3 = 10;
		      D_Board_Tx_Pkt.blood_4 = 10;
		      D_Board_Tx_Pkt.blood_5 = 10;
		      D_Board_Tx_Pkt.blood_6 = 10;
		      D_Board_Tx_Pkt.blood_7 = 10;
	      }
	      else{
		    
		      D_Board_Tx_Pkt.blood_0 = judge.info->game_robot_HP.ally_1_robot_HP;
		      D_Board_Tx_Pkt.blood_1 = judge.info->game_robot_HP.ally_2_robot_HP;
		      D_Board_Tx_Pkt.blood_2 = judge.info->game_robot_HP.ally_3_robot_HP;
		      D_Board_Tx_Pkt.blood_3 = judge.info->game_robot_HP.ally_4_robot_HP;
		      D_Board_Tx_Pkt.blood_4 = 0;
		      D_Board_Tx_Pkt.blood_5 = judge.info->game_robot_HP.ally_7_robot_HP;
		      D_Board_Tx_Pkt.blood_6 = judge.info->game_robot_HP.ally_outpost_HP;
		      D_Board_Tx_Pkt.blood_7 = judge.info->game_robot_HP.ally_base_HP;
	      }    
    ...
    case ID_robot_status:
        memcpy(&judge.info->robot_status, rxBuf, LEN_robot_status);
		    ...
		    if(judge.info->robot_status.robot_id < 10)//红
	      {
		      D_Board_Tx_Pkt.my_color = 0;
	      }
	      else{
	        D_Board_Tx_Pkt.my_color = 1;
	      }
