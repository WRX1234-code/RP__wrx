...
#define R_F_HORIZON_ANGLE (-0.149133921 + 1.8665)
#define R_B_HORIZON_ANGLE (-0.535223722 + 0.6075)
#define L_F_HORIZON_ANGLE (-1.72925425 - 1.8665+2*PI)
#define L_B_HORIZON_ANGLE (1.4232204 - 0.6075)
