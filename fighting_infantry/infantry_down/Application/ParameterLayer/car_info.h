...
#define R_F_HORIZON_ANGLE (-1.16704166 + 1.8665)
#define R_B_HORIZON_ANGLE (0.0776109695 + 0.6075)
#define L_F_HORIZON_ANGLE (1.10817409 - 1.8665)
#define L_B_HORIZON_ANGLE (-0.785649776 - 0.6075)
