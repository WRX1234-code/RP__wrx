...
#define R_F_HORIZON_ANGLE (0.855255365 + 1.8665)
#define R_B_HORIZON_ANGLE (-0.534935951 + 0.6075)
#define L_F_HORIZON_ANGLE (-1.75178492 - 1.8665+2*PI)
#define L_B_HORIZON_ANGLE (1.40452456 - 0.6075)
