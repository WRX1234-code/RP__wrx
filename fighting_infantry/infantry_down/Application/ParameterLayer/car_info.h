...
#define R_F_HORIZON_ANGLE (-1.17279422 + 1.8665)
#define R_B_HORIZON_ANGLE (0.072050333 + 0.6075)
#define L_F_HORIZON_ANGLE (1.59071422 - 1.8665)
#define L_B_HORIZON_ANGLE (-0.752476931 - 0.6075)
