...
/* Exported typedef ----------------------------------------------------------*/
#define _3508_TORQUE_CONSTANT     0.2703f //3508加减速箱的扭矩常数，N*m/A
...
#define _3508_REDUCT_RATIO        (17.255f/1.f)                                     //(268.f/17.f)//莞工减速比，如果修改方向在order_correction里改
...
typedef struct Motor_RM_Rx_Info_struct_t
{
	...
	//针对encoder_speed
	//如果带原厂减速箱，则从上往下看输出轴时，逆时针转为正，转子与输出轴同向转动；
	//如果是莞工减速箱，从上往下看莞工减速箱白色壳子，顺时针转为正，转子与输出轴反向转动
